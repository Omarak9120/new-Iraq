  ...
  return (
    <div className="space-y-20">
      ...
      <section className="py-16 relative overflow-hidden">
        ...
        >
          <div className="relative flex flex-col gap-4 p-4 w-[304px] 
                        bg-[#12131A] rounded-2xl overflow-hidden"
            style={{
              backgroundImage: `
          ...
          >
            <div className="card-border absolute z-[-1] top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2
                          ...
                          before:bg-gradient-to-b before:from-transparent before:via-[hsl(277,95%,60%)] before:to-transparent
            ...
            <hr className="w-full h-[0.1rem] bg-[#2b2d3b] border-none" />
            ...
            <ul className="flex flex-col gap-2">
              {oldStats.map((stat, index) => (
                ...
                >
                  <span className="w-4 h-4 bg-[#5e3aee] rounded-full flex items-center justify-center">
                    <Check className="w-3 h-3 text-[#12131A]" />
                  </span>
            ...
            <button className="mt-2 py-2 w-full bg-gradient-to-b from-[#5e3aee] to-[#c56bf0]
